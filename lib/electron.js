...
const electron      = require('electron'),
      {remote}      = electron,
      app           = electron.app ? electron.app : remote.app,
      BrowserWindow = electron.BrowserWindow ? electron.BrowserWindow : remote.BrowserWindow,
      dialog        = electron.dialog ? electron.dialog : remote.dialog,
      Menu          = electron.Menu ? electron.Menu : remote.Menu,
      ipcMain       = electron.ipcMain ? electron.ipcMain : remote.ipcMain,
      Tray          = electron.Tray ? electron.Tray : remote.Tray;
